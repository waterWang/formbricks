...
const DropdownMenuSubContent: React.ComponentType<DropdownMenuPrimitive.DropdownMenuSubContentProps> =
  React.forwardRef(({ className, ...props }, ref) => (
    <DropdownMenuPrimitive.SubContent
      ref={ref as any}
      className={cn(
        "z-50 min-w-32 overflow-y-auto rounded-lg border border-slate-200 bg-white p-1 font-medium text-slate-600 shadow-xs animate-in slide-in-from-left-1 hover:text-slate-700 max-h-[var(--radix-dropdown-menu-content-available-height)]",
        className
      )}
      {...props}
    />
