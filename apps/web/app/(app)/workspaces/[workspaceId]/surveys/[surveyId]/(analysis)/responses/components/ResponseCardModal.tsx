...
export const ResponseCardModal = ({
  ...
  // If no response is selected, currentIndex is invalid, or the current index is out of bounds
  // (e.g., after the last remaining response was deleted), do not render the modal
